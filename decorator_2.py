...
class Hotdog:
    ...
    def __repr__(self) -> str:
        return f'{self.name}({self.price}) -> {self._ingredients}'
...
if __name__ == '__main__':
    ...
    mashed_potatos_egg_bacon_simple_hotdog = HotdogDecorator(egg_bacon_simple_hotdog, MashedPotatoes())

    print(mashed_potatos_egg_bacon_simple_hotdog)